...
public class SystemDziekanatuMain {
    ...
    private static void startCreate() {
        ...
        StudentUITM studentUITM3 = new StudentUITM(2000, "Piotr", "Paschal", "65426", new String[]{"5", "2", "5", "4", "5"});
        StudentUITM studentUITM4 = new StudentUITM(2000, "Egor", "Wasserman", "48526", new String[]{"1", "4", "5", "5", "4"});
        StudentUITM studentUITM5 = new StudentUITM(1999, "Liza", "Block", "54526", new String[]{"2", "4", "5", "2", "3"});
        StudentUITM studentUITM6 = new StudentUITM(2000, "Betta", "Frac", "64826", new String[]{"3", "3", "5", "1", "2"});
        array[0] = studentUITM;
